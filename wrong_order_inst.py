...
class Place:
    ...
    place_name        : List[str]
    vehicle_nature    :str # Vehicle -> "v", non-artificial nature -> "n", # situation -> "s"
    ...
    nudity_genital      :str #
    old_value           :str #
    quiet_should_be     :str # Customers or users must be quiet -> "y"
    hear_listen         :str # place to hear or listen to something
    blood               :str
    dollar_700          :str
    # sometimes_sexual:str
    # dark_bright
    # complex to use
...
#                                                          veh,not,kid,poo,wea,ani ,fun,ser ,foo,mus,hol,cle ,cri,ris ,thr,exc,afr ,pic ,edu  pai ban cou  mou,nor aco,bet,spo,fir,wat,gro,eme,ret,sho,nud,old,qui,hea,blo,dol
...
_1_charity_event         =Place(["charity evenet"        ],"s","y","" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_mountain              =Place(["mountain"              ],"n","y","" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,"y" ,"" ,"" ,""  ,""  ,""  ,"" ,"" ,"" , "y","" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" )
...
_1_tent_city             =Place(["tent_city"             ],"" ,"" ,"" ,"p","y",""  ,"" ,"y" ,"" ,"" ,"u","d" ,"y",""  ,"" ,"" ,"y" ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"y","y","" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_slum                  =Place(["slum"                  ],"" ,"" ,"" ,"p","y",""  ,"" ,"y" ,"" ,"" ,"u","d" ,"y",""  ,"y","" ,"y" ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"y","y","" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_beggar_scene          =Place(["beggar scene"          ],"s","y","" ,"p","y",""  ,"" ,"y" ,"" ,"" ,"u","d" ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" )
...
_1_fountain              =Place(["fountain"              ],"" ,"y","" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"y","" ,"" ,"" ,"i","" ,"" ,"" ,"" ,"" ,"" )
...
_1_flood_scene           =Place(["flood scene"           ],"s","y","" ,"" ,"" ,""  ,"" ,"y" ,"" ,"" ,"" ,""  ,"" ,"y" ,"y","" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"y","" ,"" ,"y","" ,"y","" ,"" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_fire_scene            =Place(["fire scene"            ],"s","y","" ,"" ,"" ,""  ,"" ,"y" ,"" ,"y","" ,""  ,"" ,"y" ,"y","" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"y","" ,"y","" ,"" ,"y","" ,"" ,"" ,"" ,"" ,"" ,"y","" )
_1_robbery_scene         =Place(["robbery scene"         ],"s","y","" ,"" ,"" ,""  ,"" ,"y" ,"" ,"" ,"" ,""  ,"" ,"y" ,"y","" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"y","" ,"" ,"" ,"" ,"y","" ,"" ,"" ,"" ,"" ,"" ,"y","" )
_1_fight_scene           =Place(["fight scene"           ],"s","y","" ,"" ,"" ,""  ,"" ,"y" ,"" ,"" ,"" ,""  ,"" ,"y" ,"y","" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"y","" ,"" ,"" ,"" ,"y","" ,"" ,"" ,"" ,"" ,"" ,"y","" )
_1_murder_scene          =Place(["murder scene"          ],"s","y","" ,"" ,"" ,""  ,"" ,"y" ,"" ,"y","" ,""  ,"" ,"y" ,"y","" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"y","" ,"" ,"" ,"" ,"y","" ,"" ,"" ,"" ,"" ,"" ,"y","" )
_1_traffic_accident_scene=Place(["traffic accident scene"],"s","y","" ,"" ,"" ,""  ,"" ,"y" ,"" ,"y","" ,""  ,"" ,"y" ,"y","" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"y","" ,"y","" ,"" ,"y","" ,"" ,"" ,"" ,"" ,"" ,"y","" )
_1_massage_parlour       =Place(["massage parlour"       ],"" ,"" ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,"" ,""  ,"" ,""  ,"y","" ,""  ,""  ,""  ,"y","" ,"y", "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"s","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_wedding_hall          =Place(["wedding hall"          ],"" ,"" ,"" ,"" ,"" ,""  ,"a",""  ,"" ,"" ,"h",""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"y", "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"s","" ,"" ,"" ,"" ,"" ,"" ,"y")
_1_hotel                 =Place(["hotel"                 ],"" ,"" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,"c" ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"y", "" ,"" ,"y","" ,"" ,"" ,"" ,"" ,"" ,"s","" ,"" ,"" ,"y","" ,"" ,"y")
_1_terminal_ward         =Place(["terminal ward"         ],"" ,"" ,"" ,"s","y",""  ,"" ,"y" ,"" ,"" ,"" ,"c" ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"" , "" ,"" ,"y","y","" ,"" ,"" ,"" ,"" ,"s","" ,"" ,"" ,"y","" ,"" ,"y")
_1_psychiatric_ward      =Place(["psychiatric ward"      ],"" ,"" ,"" ,"s","y",""  ,"" ,"y" ,"" ,"" ,"" ,"c" ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"" , "" ,"" ,"y","y","" ,"" ,"" ,"" ,"" ,"s","" ,"" ,"" ,"" ,"" ,"" ,"y")
_1_dental_clinic         =Place(["dental clinic"         ],"" ,"" ,"" ,"" ,"" ,""  ,"" ,"y" ,"" ,"" ,"" ,""  ,"" ,""  ,"y","" ,""  ,""  ,""  ,"y","" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"s","" ,"" ,"" ,"" ,"" ,"" ,"y")
...
_1_kindergarten          =Place(["kindergarten"          ],"" ,"" ,"k","" ,"" ,""  ,"k",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,"y" ,"y","" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"s","" ,"" ,"" ,"" ,"" ,"" ,"y")
_1_obstetrics            =Place(["obstetrics"            ],"" ,"" ,"" ,"" ,"" ,""  ,"" ,"y" ,"" ,"" ,"h","c" ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"s","" ,"" ,"" ,"" ,"" ,"y","" )
_1_brothel               =Place(["brothel"               ],"" ,"" ,"" ,"" ,"" ,""  ,"a",""  ,"" ,"" ,"u",""  ,"" ,""  ,"" ,"y",""  ,""  ,""  ,"y","y","y", "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"a","" ,"y","" ,"" ,"" ,"" ,"" )
_1_nursing_home          =Place(["nursing home"          ],"" ,"" ,"o","" ,"y",""  ,"" ,""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"" , "" ,"y","" ,"" ,"" ,"" ,"" ,"" ,"" ,"s","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_hospital              =Place(["hospital"              ],"" ,"" ,"" ,"s","y",""  ,"" ,"y" ,"" ,"" ,"" ,"c" ,"" ,""  ,"y","" ,""  ,""  ,""  ,"y","y","" , "" ,"" ,"y","" ,"" ,"" ,"" ,"" ,"" ,"s","" ,"" ,"" ,"y","" ,"y","" )
...
_1_car_dealer            =Place(["car dealer"            ],"" ,"" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"y", "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"r","" ,"" ,"" ,"" ,"" ,"" ,"y") # vehicle?
_1_race_circuit          =Place(["race circuit"          ],"v","" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"y","y",""  ,""  ,""  ,"y","" ,"" , "" ,"" ,"" ,"" ,"y","" ,"" ,"" ,"" ,"e","i","" ,"" ,"" ,"" ,"" ,"" ) # vehicle?
_1_farm                  =Place(["farm"                  ],"" ,"" ,"" ,"" ,"" ,""  ,"" ,""  ,"y","" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"y","" ,"r","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_livestock_farm        =Place(["livestock farm"        ],"" ,"" ,"" ,"" ,"" ,"y" ,"" ,""  ,"y","" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"y","" ,"r","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_apple_store           =Place(["apple store"           ],"" ,"" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"y", "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"r","" ,"" ,"" ,"" ,"" ,"" ,"y")
_1_cloth_shop            =Place(["cloth shop"            ],"" ,"" ,"" ,"" ,"" ,""  ,"a",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"y", "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"r","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_camp_gear_shop        =Place(["camp gear shop"        ],"" ,"" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"y", "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"r","" ,"" ,"" ,"" ,"" ,"" ,"y")
...
_1_antique_shop          =Place(["antique shop"          ],"" ,"" ,"" ,"" ,"" ,""  ,"a",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"y", "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"r","" ,"" ,"y","y","" ,"" ,"y")
_1_ice_cream_truck       =Place(["ice cream truck"       ],"v","y","k","" ,"" ,""  ,"k",""  ,"y","" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"y", "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"r","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_museum                =Place(["museum"                ],"" ,"" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"y", "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"e","i","" ,"y","y","" ,"" ,"" )
_1_ancient_tree          =Place(["ancient tree"          ],"n","y","" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"e","i","" ,"y","" ,"" ,"" ,"" )
_1_remains               =Place(["remains"               ],"" ,"" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"e","i","" ,"y","" ,"" ,"" ,"" )
_1_gallery               =Place(["gallery"               ],"" ,"" ,"" ,"" ,"" ,""  ,"a",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"e","i","" ,"y","y","" ,"" ,"" )
_1_botanical_garden      =Place(["botanical_garden"      ],"" ,"" ,"" ,"" ,"" ,""  ,"a",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,"y" ,"y","" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"e","i","" ,"" ,"" ,"" ,"" ,"" )
_1_light_show            =Place(["light show"            ],"s","" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"e","i","" ,"" ,"" ,"" ,"" ,"" )
_1_library               =Place(["library"               ],"" ,"" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,"y" ,"" ,"" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"e","i","" ,"" ,"y","" ,"" ,"" )
_1_war_memorial          =Place(["war memorial"          ],"" ,"" ,"" ,"" ,"" ,""  ,"" ,"y" ,"" ,"" ,"h",""  ,"" ,""  ,"" ,"" ,""  ,""  ,"y" ,"" ,"" ,"" , "y","" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"e","i","" ,"" ,"y","" ,"y","" )
_1_rock_concert          =Place(["rock concert"          ],"" ,"" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"y",""  ,""  ,""  ,"y","" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"e","h","" ,"" ,"" ,"y","" ,"" )
_1_classic_concert       =Place(["classic concert"       ],"" ,"" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"e","h","" ,"" ,"y","y","" ,"" )
_1_comedy_club           =Place(["comedy club"           ],"" ,"" ,"" ,"" ,"" ,""  ,"a",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"e","h","" ,"" ,"" ,"y","" ,"" )
_1_magic_show            =Place(["magic show"            ],"" ,"" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"y","" ,""  ,""  ,""  ,"y","" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"e","h","" ,"" ,"" ,"" ,"" ,"" )
_1_boxing_ring           =Place(["boxing ring "          ],"" ,"" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"y","y","y" ,""  ,""  ,"y","" ,"" , "" ,"" ,"" ,"" ,"y","" ,"" ,"" ,"" ,"e","h","" ,"" ,"" ,"" ,"y","" )
_1_soccer_ground         =Place(["soccer ground"         ],"" ,"" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"y","y","y" ,""  ,""  ,"y","" ,"" , "" ,"" ,"" ,"" ,"y","" ,"" ,"y","" ,"e","h","" ,"" ,"" ,"" ,"" ,"" )
_1_strip_club            =Place(["strip club"            ],"" ,"" ,"" ,"" ,"" ,""  ,"a",""  ,"" ,"" ,"u",""  ,"" ,""  ,"" ,"y",""  ,""  ,""  ,"y","" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"e","h","y","" ,"" ,"" ,"" ,"" )
_1_fire_dance_scene      =Place(["fire dance scene"      ],"s","y","" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"y","y",""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"" ,"" ,"y","" ,"" ,"" ,"e","h","" ,"" ,"" ,"" ,"" ,"" )
...
_1_racetrack             =Place(["racetrack"             ],"" ,"" ,"" ,"" ,"" ,"y" ,"a",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"y","y",""  ,""  ,""  ,"y","y","" , "" ,"" ,"" ,"" ,"y","" ,"" ,"" ,"" ,"a","a","" ,"" ,"" ,"" ,"" ,"y")
_1_night_club            =Place(["night club"            ],"" ,"" ,"" ,"" ,"" ,""  ,"a",""  ,"" ,"" ,"u",""  ,"y",""  ,"" ,"y","y" ,"y" ,""  ,"y","" ,"" ,""  ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_roller_coaster        =Place(["roller coaster"        ],"v","" ,"" ,"" ,"" ,""  ,"k",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"y","y",""  ,""  ,""  ,"y","" ,"y", "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_sandbox               =Place(["sandbox"               ],"" ,"y","k","" ,"" ,""  ,"k",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"y","" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_swing_set             =Place(["swing set"             ],"v","y","k","" ,"" ,""  ,"k",""  ,"" ,"" ,"" ,""  ,"" ,"y" ,"" ,"" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_trampline             =Place(["trampoline"            ],"v","y","k","" ,"" ,""  ,"k",""  ,"" ,"" ,"" ,""  ,"" ,"y" ,"y","" ,""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_water_slide           =Place(["water slide"           ],"v","" ,"k","" ,"" ,""  ,"k",""  ,"" ,"" ,"" ,""  ,"" ,"y" ,"y","y",""  ,""  ,""  ,"y","" ,"y", "" ,"" ,"" ,"" ,"" ,"" ,"y","" ,"" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_jungle_gym            =Place(["jungle gym"            ],"" ,"y","k","" ,"" ,""  ,"k",""  ,"" ,"" ,"" ,""  ,"" ,"y" ,"y","y",""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_merry_go_round        =Place(["merry-go-round"        ],"v","y","k","" ,"" ,""  ,"k",""  ,"" ,"" ,"" ,""  ,"" ,"y" ,"y","y",""  ,""  ,""  ,"y","" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_see_saw               =Place(["see-saw"               ],"v","y","k","" ,"" ,""  ,"k",""  ,"" ,"" ,"" ,""  ,"" ,"y" ,"y","y",""  ,""  ,""  ,"" ,"" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_coin_pusher           =Place(["coin pusher"           ],"" ,"y","k","" ,"" ,""  ,"k",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"y","y",""  ,""  ,""  ,"y","" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_genie_machine         =Place(["genie machine"         ],"" ,"y","k","" ,"" ,""  ,"k",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"y", "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
...
_1_hot_spring            =Place(["hot spring"            ],"" ,"" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,"c" ,"" ,""  ,"" ,"" ,""  ,""  ,""  ,"y","" ,"" , "" ,"" ,"" ,"" ,"" ,"" ,"y","" ,"" ,"a","" ,"y","" ,"" ,"" ,"" ,"" )
_1_ski_area              =Place(["ski area"              ],"" ,"" ,"" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,"y" ,"" ,"y",""  ,"y" ,""  ,"y","" ,"y", "" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_beach                 =Place(["beach"                 ],"n","y","" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,"y" ,"" ,"" ,""  ,"y" ,""  ,"" ,"" ,"" , "y","" ,"" ,"" ,"" ,"" ,"y","" ,"" ,"a","" ,"y","" ,"" ,"" ,"" ,"" )
_1_forest                =Place(["forest"                ],"n","y","" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,"y" ,"" ,"" ,""  ,""  ,""  ,"" ,"" ,"" , "y","" ,"" ,"" ,"" ,"" ,"" ,"" ,"" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_river                 =Place(["river"                 ],"n","y","" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,"y" ,"" ,"" ,""  ,""  ,""  ,"" ,"" ,"" , "y","" ,"" ,"" ,"" ,"" ,"y","" ,"" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_campground            =Place(["campground"            ],"" ,"y","" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"y",""  ,""  ,""  ,"y","" ,"" , "" ,"" ,"y","" ,"" ,"y","" ,"y","" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_ocean                 =Place(["ocean"                 ],"n","y","" ,"" ,"" ,""  ,"b",""  ,"" ,"" ,"" ,""  ,"" ,"y" ,"" ,"" ,""  ,""  ,""  ,"" ,"" ,"" , "y","" ,"" ,"" ,"" ,"" ,"y","" ,"" ,"a","" ,"" ,"" ,"" ,"" ,"" ,"" )
_1_school                =Place(["school"                ],"" ,"" ,"k","" ,"" ,""  ,"" ,""  ,"" ,"" ,"" ,""  ,"" ,""  ,"" ,"" ,""  ,""  ,"y" ,"" ,"" ,"" , "" ,"y","" ,"" ,"" ,"" ,"" ,"" ,"" ,"s","" ,"" ,"" ,"" ,"y","" ,"y")
...
for i in Place.ALL_PLACES:
    ...
    if i.vehicle_nature == 'v':
        inst_vehicle.append(name)
    if i.vehicle_nature == 'v' and     i.fun_for_kid_adult:
        inst_vehicle_enjoy.append(name)
    if i.vehicle_nature == 'v' and not i.fun_for_kid_adult or (i.vehicle_nature == 'v' and i.retail_service_amusement_entertainment == "e"):
        inst_vehicle_non_enjoy.append(name)
    if i.vehicle_nature == 'n':
        inst_nature.append(name)

    if i.kid_old == 'k':
        inst_kid.append(name)
    if i.kid_old == 'o':
        inst_old.append(name)

    if i.poor_sick == 's' or i.poor_sick == 'b':
        inst_sick.append(name)
    if i.poor_sick == 'p' or i.poor_sick == 'b':
        inst_poor.append(name)

    if i.weaks:
        inst_weaks.append(name)
    ...
    if (i.excite or i.thrilling or i.show_human_animal_inanimate == 'h') and not i.quiet_should_be:
        inst_scream_noisy.append(i.place_name[0])
    if i.hear_listen:
        inst_hear_listen.append(i.place_name[0])

    if i.hear_listen and i.educational:
        inst_hear_listen_educational.append(i.place_name[0])

    if i.excite or i.thrilling:
        inst_excite_thrilling.append(i.place_name[0])


    if i.blood and     i.sport:
        inst_blood_sport.append(i.place_name[0])
    if i.blood and not i.sport or (i.sport and i.affray and not i.blood): # 病院が入っちゃう
        inst_blood_serious.append(i.place_name[0])
    if i.water:
        inst_water.append(i.place_name[0])
    if i.nudity_genital and i.holy_unholy == 'n':
        inst_sex_shop.append(i.place_name[0])
    if i.retail_service_amusement_entertainment == 'e':
        inst_entertainment.append(i.place_name[0])
